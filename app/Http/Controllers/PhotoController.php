    ...
    public function uploadImage(Request $request)
    {
       ...
       function calCode($users,$text) {
        ...
        $request->validate([
            ...
            'photo_type_bld.*' => 'image|mimes:jpeg,png,jpg,gif,svg|max:2048',
            'photo_type_land' => 'required' ,
            'photo_type_land.*' => 'image|mimes:jpeg,png,jpg,gif,svg|max:2048',
            'photo_type_river_before' => 'required' ,
            'photo_type_river_before.*' => 'image|mimes:jpeg,png,jpg,gif,svg|max:2048',
            'photo_type_river_prob' => 'required' ,
            'photo_type_river_prob.*' => 'image|mimes:jpeg,png,jpg,gif,svg|max:2048',
            'photo_type_river_after' => 'required' ,
            'photo_type_river_after.*' => 'image|mimes:jpeg,png,jpg,gif,svg|max:2048',
            'photo_type_prob_sketch' => 'required' ,
            'photo_type_prob_sketch.*' => 'image|mimes:jpeg,png,jpg,gif,svg|max:2048'
        ]);
        //dd($request->all());
        ...
        // return redirect()->route("form.getBlockageData");
        // return redirect()->route("getBlockageID",[$blockageId]); 
      //  getBlockageID/{id}
            // return redirect()->route('getBlockageID', [$blockageId]);

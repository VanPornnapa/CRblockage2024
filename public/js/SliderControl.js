L.Control.SliderControl = L.Control.extend({
    ...
    onAdd: function (map) {
        ...
        $(sliderContainer).append('<div id="leaflet-slider" style="width:300px;"><div id="slider-timestamp" style="width:100%; margin-top:-20px; background-color:#fff; text-align:center; border-radius:5px;"></div></div>');

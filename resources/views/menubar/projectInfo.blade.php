                        ...
                        <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                            ...
                            <div class="card">
                                <div class="card-header">
                                    <h2 class="card-title text-center">โครงการพัฒนาระบบสารสนเทศเตรียมความพร้อมเพื่อรับมือภัยน้ำท่วมและดินถล่ม จังหวัดเชียงราย</h2>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-xl-10 col-lg-10 col-md-10 col-sm-10 col-10" >
                                            <div class="text"> 
                                                ...
                                                <b>กิจกรรมหลักที่ 1</b> : 	การพัฒนาระบบข้อมูลของสิ่งกีดขวางทางน้ำในลำน้ำคูคลองและถนน และวิธีการแก้ไขปัญหาการกีดขวางทางน้ำแต่ละแห่งในพื้นที่ของจังหวัดเชียงราย <br>
                                                
                                                <b>กิจกรรมหลักที่ 2 </b> :	การพัฒนาระบบสารสนเทศเขตเสี่ยงภัยดินถล่มบริเวณสถานที่ท่องเที่ยวสำคัญที่เป็นลาดเชิงเขาเพื่อวางแผนการใช้พื้นที่ซึ่งเสี่ยงต่อปัญหาจากดินถล่ม 
                                                ...
                                                <div class="text"> 
                                                    ...
                                                    <b> ระบบสารสนเทศเตรียมความพร้อมเพื่อรับมือภัยน้ำท่วมและดินถล่ม </b>
                                                    <div align="center">
                                                          <img src="{{ asset('images/logo/qr.png') }}" width="20%"> <br>
                                                          เว็บไซต์ : <a href="https://blockage.crflood.com/"> www.blockage.crflood.com </a> <br>
                                                          ดาวน์โหลด : <a href="{{ asset('images/logo/qr.png') }}" download> QRcode  </a>
                                                    </div>
